...
| Enum | 值 |
|------|-----|
| FeatureCode | BASIC_BOOKING, BASIC_CUSTOMER, BASIC_STAFF, BASIC_SERVICE, BASIC_REPORT (免費), UNLIMITED_STAFF, ADVANCED_REPORT, COUPON_SYSTEM, MEMBERSHIP_SYSTEM, POINT_SYSTEM, PRODUCT_SALES, AUTO_REMINDER, AUTO_BIRTHDAY, AUTO_RECALL, EXTRA_PUSH, ADVANCED_CUSTOMER, AI_ASSISTANT, CUSTOM_RICH_MENU, MULTI_ACCOUNT, MULTI_BRANCH (付費) |
...
| ProductOrderStatus | PENDING, CONFIRMED, COMPLETED, CANCELLED | 商品訂單狀態 |
| InventoryActionType | IN, OUT, ADJUST | 庫存異動類型 |
...
| Enum | 值 | 說明 |
|------|-----|------|
| ConversationState | IDLE, SELECTING_CATEGORY, SELECTING_SERVICE, SELECTING_STAFF, SELECTING_DATE, SELECTING_TIME, CONFIRMING_BOOKING, CONFIRMING_CANCEL_BOOKING, BROWSING_PRODUCTS, VIEWING_PRODUCT_DETAIL, SELECTING_QUANTITY, CONFIRMING_PURCHASE, BROWSING_COUPONS, VIEWING_MY_COUPONS, VIEWING_MEMBER_INFO | 對話狀態 |
