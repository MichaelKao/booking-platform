...
public enum FeatureCode {
    ...
    AUTO_BIRTHDAY("自動生日祝福", "自動發送生日祝福與優惠", false, 200, true),
    AUTO_REMINDER("自動預約提醒", "自動發送預約提醒通知", false, 200, true),
    AUTO_RECALL("自動喚回通知", "自動發送久未到店顧客喚回通知", false, 300, true),

    // ========================================
    // 加值功能 - 進階功能
    // ========================================

    AI_ASSISTANT("AI 智慧客服", "AI 自動回覆顧客問題（Groq Llama 3.3）", false, 1000, true),
    ADVANCED_CUSTOMER("進階顧客篩選", "進階顧客標籤與篩選功能", false, 300, true),
